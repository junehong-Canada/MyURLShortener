...
from urlshortener_dynamodb import create_url_table, create_url, get_short_url_id, get_url_by_id, increment_clicks
...
def create_short_url():
    ...
    existing_short_id = get_short_url_id(long_url)
...
def redirect_to_long_url(short_id):
    ...
    # Get URL from DynamoDB if not in cache
    url_mapping = get_url_by_id(short_id)
    if not url_mapping:
